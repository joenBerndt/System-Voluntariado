# Especificación Técnica Completa de los 25 Casos de Uso
...
### CU-25: Ver Entrevistas
* **Descripción:** El sistema deberá permitir al Candidato visualizar el cronograma y detalles de las entrevistas programadas asociadas a sus postulaciones, facilitando la asistencia y preparación.
* **Actor:** Candidato.
* **Flujo Básico:**
  1. El Candidato accede a la sección "Mis Entrevistas" dentro de su intranet.
  2. El Sistema consulta las postulaciones del usuario que tienen una entrevista programada o confirmada.
  3. El Sistema presenta un listado de entrevistas ordenadas cronológicamente (próximas primero).
  4. El Sistema muestra, para cada entrevista: Título de la convocatoria, Fecha, Hora, Ubicación (física o virtual) y notas adicionales.
  5. El Sistema resalta visualmente las entrevistas que ocurrirán en el día actual o en breve.
* **Subflujos:**
  1. **Filtrar Entrevistas:** El Candidato puede visualizar por separado las entrevistas "Próximas" y el "Historial" (pasadas).
* **Flujos Alternativos:**
  1. **Sin Entrevistas Programadas:** Si el usuario no tiene entrevistas futuras, el Sistema muestra un mensaje claro indicando que verificará cuando el administrador programe una.
* **Precondiciones:** El Candidato debe tener al menos una postulación en estado `interview_pending` o `interview_confirmed` con fecha asignada.
* **Postcondiciones:** El Candidato conoce los detalles logísticos de su entrevista.
* **Puntos de Extensión:**
  - **CU-08 (Consultar Estado de Postulaciones):** La entrevista es un hito dentro del seguimiento de la postulación.
* **Requerimientos Especiales:** RF-02 (Alertas visuales de proximidad), Mostrar enlace de videollamada si la ubicación es virtual.
* **Excepciones:** Si la entrevista fue cancelada por el administrador, debe reflejarse el cambio de estado y no aparecer como activa.
