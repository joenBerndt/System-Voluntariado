...
export function VolunteersAdmin({ isAdminJunior = false, currentUser }: VolunteersProps) {
  ...
  const handleDeactivateActiveVolunteer = () => {
    if (!activeVolunteer) return;
    ...
    setConfirmation({
      ...
      description: `¿Está seguro de desactivar a ${activeVolunteer.name}? Este usuario PERMANECERÁ en el sistema, pero será retirado de todos sus proyectos (${volunteerAssignments.length}) y pasará a estado Inactivo.`,
