...
export function VolunteerDashboard({ currentUser, applications = [] }: VolunteerDashboardProps) {
  ...
  console.log('Dashboard - Project IDs from Assignments:', projectIdsFromAssignments);
  console.log('Dashboard - Accepted Applications:', acceptedApplications);
  console.log('Dashboard - Project IDs from Applications:', projectIdsFromApplications);
  console.log('Dashboard - All Projects:', projects);
  console.log('Dashboard - My Projects:', myProjects);
  console.log('Dashboard - Active Projects:', activeProjects);
  console.log('Dashboard - My Progress:', myProgress);
  console.log('Dashboard - Total Trainings:', totalTrainings);
  console.log('Dashboard - Completed Trainings:', completedTrainings);
  ...
  const stats = [
    ...
    },
    {
      ...
      description: `${completedTrainings} de ${totalTrainings} materiales`
    },
  ];
